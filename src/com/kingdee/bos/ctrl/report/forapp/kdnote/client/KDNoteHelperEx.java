...
public class KDNoteHelperEx extends KDNoteHelper {
	...
	public void print(String templateType, Object dataProvider, java.awt.Component owner, boolean isShowPrinterDialog)  {
		...
		try {
	      Template template = readDefaultTemplate(templateType, owner);
	      if(template != null)  {
	          ...
	          if(templateModel != null && helper != null) {
	              ...
	              helper.print(templateModel, false, isShowPrinterDialog, owner, (new StringBuilder()).append(MultiLanguageUtil.getMLS("client.KDNoteHelper.title", "EAS套打 - ")).append(alias).toString());	      
	          }
	      }
