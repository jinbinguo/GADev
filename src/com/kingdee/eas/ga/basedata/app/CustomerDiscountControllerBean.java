...
public class CustomerDiscountControllerBean extends AbstractCustomerDiscountControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.ga.basedata.app.CustomerDiscountControllerBean");
}