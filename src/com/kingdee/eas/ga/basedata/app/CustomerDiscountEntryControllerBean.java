...
public class CustomerDiscountEntryControllerBean extends AbstractCustomerDiscountEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.ga.basedata.app.CustomerDiscountEntryControllerBean");
}