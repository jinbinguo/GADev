...
public class DMSWipNoForStocktaking extends CoreBase implements IDMSWipNoForStocktaking
{
    public DMSWipNoForStocktaking()
    {
        super();
        registerInterface(IDMSWipNoForStocktaking.class, this);
    }
    public DMSWipNoForStocktaking(Context ctx)
    {
        super(ctx);
        registerInterface(IDMSWipNoForStocktaking.class, this);
    }
    ...
    private DMSWipNoForStocktakingController getController() throws BOSException
    {
        return (DMSWipNoForStocktakingController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDMSWipNoForStocktakingInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDMSWipNoForStocktakingInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDMSWipNoForStocktakingInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDMSWipNoForStocktakingCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDMSWipNoForStocktakingCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDMSWipNoForStocktakingCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
