...
public class DMSWipBillEntry2 extends CoreBillEntryBase implements IDMSWipBillEntry2
{
    public DMSWipBillEntry2()
    {
        super();
        registerInterface(IDMSWipBillEntry2.class, this);
    }
    public DMSWipBillEntry2(Context ctx)
    {
        super(ctx);
        registerInterface(IDMSWipBillEntry2.class, this);
    }
    ...
    private DMSWipBillEntry2Controller getController() throws BOSException
    {
        return (DMSWipBillEntry2Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDMSWipBillEntry2Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDMSWipBillEntry2Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDMSWipBillEntry2Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDMSWipBillEntry2Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDMSWipBillEntry2Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDMSWipBillEntry2Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
