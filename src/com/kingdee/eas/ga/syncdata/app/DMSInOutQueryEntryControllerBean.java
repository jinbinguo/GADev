...
public class DMSInOutQueryEntryControllerBean extends AbstractDMSInOutQueryEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.ga.syncdata.app.DMSInOutQueryEntryControllerBean");
}