...
public class DMSPrintContentControllerBean extends AbstractDMSPrintContentControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.ga.syncdata.app.DMSPrintContentControllerBean");
}