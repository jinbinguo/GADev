...
public class DMSInOutQueryControllerBean extends AbstractDMSInOutQueryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.ga.syncdata.app.DMSInOutQueryControllerBean");
}