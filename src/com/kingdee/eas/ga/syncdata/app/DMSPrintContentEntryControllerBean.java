...
public class DMSPrintContentEntryControllerBean extends AbstractDMSPrintContentEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.ga.syncdata.app.DMSPrintContentEntryControllerBean");
}