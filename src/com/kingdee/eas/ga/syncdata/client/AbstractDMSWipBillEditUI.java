...
public abstract class AbstractDMSWipBillEditUI extends com.kingdee.eas.myframework.template.base.client.SimpleBizBillEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtEntry3.setFormatXml(resHelper.translateString("kdtEntry3",kdtEntry3StrXML));
                ...
                this.kdtEntry3.putBindContents("editData",new String[] {"seq","accountCode","realLineSeq","standardHour","lastEditTime","remark","discountRate","lineSeq","dispatchStatus","unitMI","hourRate","taxBillCode","wip","payCode","billNum","billStatus"});
        ...
        kdtEntry3_standardHour_TextField.setDataType(0);
