 ...
 * output class name
 */
public class DMSInOutQueryListUI extends AbstractDMSInOutQueryListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DMSInOutQueryListUI.class);
    
    /**
     * output class constructor
     */
    public DMSInOutQueryListUI() throws Exception
    {
        super();
    }
