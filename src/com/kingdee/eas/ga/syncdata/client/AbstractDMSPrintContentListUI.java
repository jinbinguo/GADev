 ...
 * output class name
 */
public abstract class AbstractDMSPrintContentListUI extends com.kingdee.eas.myframework.template.base.client.SimpleBizBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDMSPrintContentListUI.class);
    /**
     * output class constructor
     */
    public AbstractDMSPrintContentListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDMSPrintContentListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.ga.syncdata.app", "DMSPrintContentQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.ga.syncdata.app.DMSPrintContentListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.ga.syncdata.client", "DMSPrintContentListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.ga.syncdata.client.DMSPrintContentEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.ga.syncdata.DMSPrintContentFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.ga.syncdata.DMSPrintContentInfo objectValue = new com.kingdee.eas.ga.syncdata.DMSPrintContentInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","status","number","bizDate","desc","creator.id","creator.name","createTime","auditor.id","auditor.name","auditTime","serviceOrgUnit.name"};
    }



	protected String getTDFileName() {
    	return "/bim/ga/syncdata/DMSPrintContent";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.ga.syncdata.app.DMSPrintContentQuery");
	}
