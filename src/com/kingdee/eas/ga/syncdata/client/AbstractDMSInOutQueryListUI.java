 ...
 * output class name
 */
public abstract class AbstractDMSInOutQueryListUI extends com.kingdee.eas.myframework.template.base.client.SimpleBizBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDMSInOutQueryListUI.class);
    /**
     * output class constructor
     */
    public AbstractDMSInOutQueryListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDMSInOutQueryListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.ga.syncdata.app", "DMSInOutQueryQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.ga.syncdata.app.DMSInOutQueryListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.ga.syncdata.client", "DMSInOutQueryListUI");
    }
    /**
    ...
    {
        return new String[] {"id","status","serviceOrgUnit","number","bizDate","desc","creator.id","creator.name","createTime","auditor.id","auditor.name","auditTime"};
    }
