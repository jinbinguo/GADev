 ...
 * output class name
 */
public class SyncLogListUI extends AbstractSyncLogListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SyncLogListUI.class);
    
    /**
     * output class constructor
     */
    public SyncLogListUI() throws Exception
    {
        super();
    }
