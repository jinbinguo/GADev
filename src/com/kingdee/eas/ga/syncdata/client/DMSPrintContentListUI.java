 ...
 * output class name
 */
public class DMSPrintContentListUI extends AbstractDMSPrintContentListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DMSPrintContentListUI.class);
    
    /**
     * output class constructor
     */
    public DMSPrintContentListUI() throws Exception
    {
        super();
    }
