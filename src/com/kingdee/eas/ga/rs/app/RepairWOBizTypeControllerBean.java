...
public class RepairWOBizTypeControllerBean extends AbstractRepairWOBizTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.ga.rs.app.RepairWOBizTypeControllerBean");
}