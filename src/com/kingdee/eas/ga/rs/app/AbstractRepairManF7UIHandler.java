 ...
 * output class name
 */
public abstract class AbstractRepairManF7UIHandler extends com.kingdee.eas.framework.app.CoreUIObjectHandler

{
	...
	public void handleActionOnLoad(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionOnLoad(request,response,context);
	}
	protected void _handleActionOnLoad(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}