...
public class RepairManEntryControllerBean extends AbstractRepairManEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.ga.rs.app.RepairManEntryControllerBean");
}