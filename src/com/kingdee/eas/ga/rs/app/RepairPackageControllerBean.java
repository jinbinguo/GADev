...
public class RepairPackageControllerBean extends AbstractRepairPackageControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.ga.rs.app.RepairPackageControllerBean");
}