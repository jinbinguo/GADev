...
public abstract class AbstractRepairManListUI extends com.kingdee.eas.myframework.template.base.client.SimpleBizBillListUI
{
    ...
    {
        return new String[] {"number","entrys.vehicle.number","plateNum","name","tel","email","addr","idNumber","zipCode","vIN","engineNum","seriesName","modelName","brandName","id","status","bizDate","desc","creator.id","creator.name","createTime","auditor.id","auditor.name","auditTime","orgUnit.name"};
    }
