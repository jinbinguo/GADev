 ...
 * output class name
 */
public class PurTestListUI extends AbstractPurTestListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PurTestListUI.class);
    
    /**
     * output class constructor
     */
    public PurTestListUI() throws Exception
    {
        super();
    }
