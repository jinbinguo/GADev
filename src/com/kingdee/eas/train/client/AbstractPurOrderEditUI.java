...
public abstract class AbstractPurOrderEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    ...
    protected com.kingdee.eas.train.PurOrderInfo editData = null;
    ...
    private void jbInit() throws Exception
    {
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","material","material.name","material.model","unit","qty","price","amount","deliveryDate","insideQty","sourceBillNumber","sourceBillEntrySeq"});
        ...
        KDDatePicker kdtEntrys_deliveryDate_DatePicker = new KDDatePicker();
        kdtEntrys_deliveryDate_DatePicker.setName("kdtEntrys_deliveryDate_DatePicker");
        kdtEntrys_deliveryDate_DatePicker.setVisible(true);
        kdtEntrys_deliveryDate_DatePicker.setEditable(true);
        KDTDefaultCellEditor kdtEntrys_deliveryDate_CellEditor = new KDTDefaultCellEditor(kdtEntrys_deliveryDate_DatePicker);
        this.kdtEntrys.getColumn("deliveryDate").setEditor(kdtEntrys_deliveryDate_CellEditor);
        KDFormattedTextField kdtEntrys_insideQty_TextField = new KDFormattedTextField();
        kdtEntrys_insideQty_TextField.setName("kdtEntrys_insideQty_TextField");
        kdtEntrys_insideQty_TextField.setVisible(true);
        kdtEntrys_insideQty_TextField.setEditable(true);
        kdtEntrys_insideQty_TextField.setHorizontalAlignment(2);
        kdtEntrys_insideQty_TextField.setDataType(1);
        	kdtEntrys_insideQty_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_insideQty_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_insideQty_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_insideQty_CellEditor = new KDTDefaultCellEditor(kdtEntrys_insideQty_TextField);
        this.kdtEntrys.getColumn("insideQty").setEditor(kdtEntrys_insideQty_CellEditor);
        KDTextField kdtEntrys_sourceBillNumber_TextField = new KDTextField();
        kdtEntrys_sourceBillNumber_TextField.setName("kdtEntrys_sourceBillNumber_TextField");
        kdtEntrys_sourceBillNumber_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntrys_sourceBillNumber_CellEditor = new KDTDefaultCellEditor(kdtEntrys_sourceBillNumber_TextField);
        this.kdtEntrys.getColumn("sourceBillNumber").setEditor(kdtEntrys_sourceBillNumber_CellEditor);
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtpurOrg,prmtsupplier,prmtpurPerson,payType,status,pkauditTime,kDDateLastUpdateTime,prmtLastUpdateUser,kDDateCreateTime,prmtCreator,prmtAuditor,txtDescription,pkBizDate,txtNumber,kdtEntrys}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(contLastUpdateUser, new KDLayout.Constraints(341, 514, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateTime.setBounds(new Rectangle(341, 538, 270, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(341, 538, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contDescription.setBounds(new Rectangle(10, 58, 611, 19));
        this.add(contDescription, new KDLayout.Constraints(10, 58, 611, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.train.PurOrderEntryInfo(),null,false);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.train.PurOrderEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.deliveryDate", java.util.Date.class, this.kdtEntrys, "deliveryDate.text");
		dataBinder.registerBinding("entrys.insideQty", java.math.BigDecimal.class, this.kdtEntrys, "insideQty.text");
		dataBinder.registerBinding("entrys.sourceBillNumber", String.class, this.kdtEntrys, "sourceBillNumber.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.train.app.PurOrderEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.train.PurOrderInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.deliveryDate", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.insideQty", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.sourceBillNumber", ValidateHelper.ON_SAVE);    
...
kdtEntrys.getCell(rowIndex,"model").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"material").getValue(),"model"));
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPurOrderEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPurOrderEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.train.client", "PurOrderEditUI");
    }
    /**
