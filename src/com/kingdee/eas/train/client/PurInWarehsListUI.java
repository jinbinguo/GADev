 ...
 * output class name
 */
public class PurInWarehsListUI extends AbstractPurInWarehsListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PurInWarehsListUI.class);
    
    /**
     * output class constructor
     */
    public PurInWarehsListUI() throws Exception
    {
        super();
    }
