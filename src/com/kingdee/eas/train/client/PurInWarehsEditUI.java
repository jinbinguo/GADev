 ...
 * output class name
 */
public class PurInWarehsEditUI extends AbstractPurInWarehsEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PurInWarehsEditUI.class);
    
    /**
     * output class constructor
     */
    public PurInWarehsEditUI() throws Exception
    {
        super();
    }
    /**
