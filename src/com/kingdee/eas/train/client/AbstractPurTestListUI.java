 ...
 * output class name
 */
public abstract class AbstractPurTestListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPurTestListUI.class);
     ...
     */
    public AbstractPurTestListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPurTestListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.train.app", "PurTestQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.train.app.PurTestListUIHandler";
	}
...
com.kingdee.eas.train.PurTestInfo editData = (com.kingdee.eas.train.PurTestInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
com.kingdee.eas.train.PurTestFactory.getRemoteInstance().audit(editData);
    }
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPurTestListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPurTestListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPurTestListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.train.client", "PurTestListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.train.client.PurTestEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.train.PurTestFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.train.PurTestInfo objectValue = new com.kingdee.eas.train.PurTestInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","purOrg.name","requestPerson.name","requestDept.name","entrys.material.number","entrys.unit.name","auditDate"};
    }



	protected String getTDFileName() {
    	return "/bim/train/PurTest";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.train.app.PurTestQuery");
	}
