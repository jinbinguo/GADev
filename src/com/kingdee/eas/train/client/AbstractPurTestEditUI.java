 ...
 * output class name
 */
public abstract class AbstractPurTestEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPurTestEditUI.class);
    ...
    protected com.kingdee.eas.train.PurTestInfo editData = null;
    protected ActionAudit actionAudit = null;
    /**
     * output class constructor
     */
    public AbstractPurTestEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPurTestEditUI.class.getName());
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","material","material.name","material.model","unit","qty","price","amount","requestDate"});
        ...
        KDTextField kdtEntrys_models_TextField = new KDTextField();
        kdtEntrys_models_TextField.setName("kdtEntrys_models_TextField");
        kdtEntrys_models_TextField.setMaxLength(255);
        KDTDefaultCellEditor kdtEntrys_models_CellEditor = new KDTDefaultCellEditor(kdtEntrys_models_TextField);
        this.kdtEntrys.getColumn("models").setEditor(kdtEntrys_models_CellEditor);
        ...
        this.prmtrequestPerson.setVisible(true);		
        ...
        this.prmtrequestDept.setVisible(true);		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtpurOrg,prmtrequestPerson,prmtrequestDept,pkauditDate}));
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(341, 514, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(341, 514, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(672, 514, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(672, 514, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateUser.setBounds(new Rectangle(341, 538, 270, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(341, 538, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateTime.setBounds(new Rectangle(672, 538, 270, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(672, 538, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contBizDate.setBounds(new Rectangle(730, 10, 270, 19));
        this.add(contBizDate, new KDLayout.Constraints(730, 10, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contDescription.setBounds(new Rectangle(10, 58, 603, 19));
        this.add(contDescription, new KDLayout.Constraints(10, 58, 603, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditor.setBounds(new Rectangle(10, 514, 270, 19));
        this.add(contAuditor, new KDLayout.Constraints(10, 514, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtEntrys.setBounds(new Rectangle(10, 82, 991, 413));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.train.PurTestEntryInfo(),null,false);
        ...
        contpurOrg.setBounds(new Rectangle(318, 11, 265, 19));
        this.add(contpurOrg, new KDLayout.Constraints(318, 11, 265, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contrequestPerson.setBounds(new Rectangle(10, 34, 270, 19));
        this.add(contrequestPerson, new KDLayout.Constraints(10, 34, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contrequestDept.setBounds(new Rectangle(305, 39, 270, 19));
        this.add(contrequestDept, new KDLayout.Constraints(305, 39, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contauditDate.setBounds(new Rectangle(10, 538, 270, 19));
        this.add(contauditDate, new KDLayout.Constraints(10, 538, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.train.PurTestEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.material.model", String.class, this.kdtEntrys, "models.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.train.app.PurTestEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.train.PurTestInfo)ov;
    }
...
kdtEntrys.getCell(rowIndex,"models").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"material").getValue(),"model"));
...
kdtEntrys.getCell(rowIndex,"amount").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimal(com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimalValue(kdtEntrys.getCell(rowIndex,"qty").getValue())* com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimalValue(kdtEntrys.getCell(rowIndex,"price").getValue())));
...
kdtEntrys.getCell(rowIndex,"amount").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimal(com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimalValue(kdtEntrys.getCell(rowIndex,"qty").getValue())* com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimalValue(kdtEntrys.getCell(rowIndex,"price").getValue())));
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPurTestEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.train.client", "PurTestEditUI");
    }
    /**
