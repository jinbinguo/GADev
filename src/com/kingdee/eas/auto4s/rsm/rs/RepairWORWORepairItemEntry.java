...
public class RepairWORWORepairItemEntry extends CoreBillEntryBase implements IRepairWORWORepairItemEntry
{
    public RepairWORWORepairItemEntry()
    {
        super();
        registerInterface(IRepairWORWORepairItemEntry.class, this);
    }
    public RepairWORWORepairItemEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IRepairWORWORepairItemEntry.class, this);
    }
    ...
    private RepairWORWORepairItemEntryController getController() throws BOSException
    {
        return (RepairWORWORepairItemEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRepairWORWORepairItemEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRepairWORWORepairItemEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRepairWORWORepairItemEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRepairWORWORepairItemEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRepairWORWORepairItemEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRepairWORWORepairItemEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
