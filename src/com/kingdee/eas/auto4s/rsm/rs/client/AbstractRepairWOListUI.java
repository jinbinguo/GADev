...
public abstract class AbstractRepairWOListUI extends com.kingdee.eas.auto4s.autoframework.core.client.AutoBillBaseListUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        Status.setBounds(new Rectangle(385, 107, 170, 19));
        this.add(Status, new KDLayout.Constraints(385, 107, 170, 19, 0));
        //coutComeTime1
    ...
    {
        return new String[] {"id","number","Vehicle.plateNum","Vehicle.vIN","series.name","model.name","Customer.name","CustomerDiscount.name","RepairSender","Tel","ComeTime","IntendDeliveryTime","FactDeliveryTime","Mile","KeyNumber","gaBillStatus","Status","RepairType.name","WarrantyType.name","CompanyNumber","InsuranCompany.name","IsStat","IsWash","IsWaitForStore","IsPriorAssign","IsWorkCost","RepairTotalAmount","RepairWay","groupOrgunit.name","Supplier.name","IsReceive","IsPay","SA.name","OrgUnit.name","Brand.name"};
    }
