...
public abstract class AbstractRepairWOEditUI extends com.kingdee.eas.auto4s.autoframework.core.client.AutoBillBaseEditUI
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contgaBillStatus;
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkisPrintedSettle;
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contPrmtVin;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contwipRemark;
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contdmsWip;
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtrepairBizType;
    protected com.kingdee.bos.ctrl.swing.KDDatePicker pkfirstBookInDate;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtVin;
    protected com.kingdee.bos.ctrl.swing.KDScrollPane scrollPanewipRemark;
    protected com.kingdee.bos.ctrl.swing.KDTextArea txtwipRemark;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtdmsWip;
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox gaBillStatus;
    ...
    private void jbInit() throws Exception
    {
        ...
        //actionShowRemarkList
        this.actionShowRemarkList = new ActionShowRemarkList(this);
        getActionManager().registerAction("actionShowRemarkList", actionShowRemarkList);
         this.actionShowRemarkList.addService(new com.kingdee.eas.framework.client.service.PermissionService());
        //actionSplitLine
        ...
        this.contgaBillStatus = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.chkisPrintedSettle = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.contPrmtVin = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contwipRemark = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.contdmsWip = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.prmtrepairBizType = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.pkfirstBookInDate = new com.kingdee.bos.ctrl.swing.KDDatePicker();
        this.prmtVin = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.scrollPanewipRemark = new com.kingdee.bos.ctrl.swing.KDScrollPane();
        this.txtwipRemark = new com.kingdee.bos.ctrl.swing.KDTextArea();
        ...
        this.txtdmsWip = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.gaBillStatus = new com.kingdee.bos.ctrl.swing.KDComboBox();
        ...
        this.contgaBillStatus.setName("contgaBillStatus");
        this.chkisPrintedSettle.setName("chkisPrintedSettle");
        ...
        this.contPrmtVin.setName("contPrmtVin");
        this.contwipRemark.setName("contwipRemark");
        this.contbizPerson.setName("contbizPerson");
        this.contbizDept.setName("contbizDept");
        this.contdmsWip.setName("contdmsWip");
        ...
        this.prmtrepairBizType.setName("prmtrepairBizType");
        this.pkfirstBookInDate.setName("pkfirstBookInDate");
        this.prmtVin.setName("prmtVin");
        this.scrollPanewipRemark.setName("scrollPanewipRemark");
        this.txtwipRemark.setName("txtwipRemark");
        this.prmtbizPerson.setName("prmtbizPerson");
        this.prmtbizDept.setName("prmtbizDept");
        this.txtdmsWip.setName("txtdmsWip");
        ...
        this.gaBillStatus.setName("gaBillStatus");
        ...
        this.contSeries.setBoundLabelLength(80);		
        ...
        this.contModel.setBoundLabelLength(80);		
        ...
        this.contVIN.setBoundLabelLength(80);		
        ...
        this.contTel.setBoundLabelLength(80);		
        ...
        this.contCompanyNumber.setBoundLabelLength(80);		
        ...
        this.contMile.setBoundLabelLength(80);		
        ...
        this.contIntendDeliveryTime.setBoundLabelLength(80);		
        ...
        this.contComeTime.setBoundLabelLength(80);		
        ...
        this.contSA.setBoundLabelLength(80);		
        ...
        this.contVehicle.setBoundLabelLength(80);		
        ...
        this.contBrand.setBoundLabelLength(80);		
        ...
        // kDTabbedPane1
        // contgaBillStatus		
        this.contgaBillStatus.setBoundLabelText(resHelper.getString("contgaBillStatus.boundLabelText"));		
        this.contgaBillStatus.setBoundLabelLength(80);		
        this.contgaBillStatus.setBoundLabelUnderline(true);		
        this.contgaBillStatus.setVisible(true);
        // chkisPrintedSettle		
        this.chkisPrintedSettle.setText(resHelper.getString("chkisPrintedSettle.text"));		
        this.chkisPrintedSettle.setHorizontalAlignment(2);		
        this.chkisPrintedSettle.setEnabled(false);
        // kDPBizInfo
        // kDPVehicleInfo
        // kDPHideField
        // contcustomInfo		
        this.contcustomInfo.setBoundLabelText(resHelper.getString("contcustomInfo.boundLabelText"));		
        this.contcustomInfo.setBoundLabelLength(80);		
        ...
        this.contCustomerAccount.setBoundLabelLength(80);		
        this.contCustomerAccount.setBoundLabelUnderline(true);		
        this.contCustomerAccount.setVisible(true);
        // contrepairBizType		
        this.contrepairBizType.setBoundLabelText(resHelper.getString("contrepairBizType.boundLabelText"));		
        this.contrepairBizType.setBoundLabelLength(80);		
        this.contrepairBizType.setBoundLabelUnderline(true);		
        this.contrepairBizType.setVisible(true);
        // contfirstBookInDate		
        this.contfirstBookInDate.setBoundLabelText(resHelper.getString("contfirstBookInDate.boundLabelText"));		
        this.contfirstBookInDate.setBoundLabelLength(80);		
        ...
        this.btnShowRepairSender.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    btnShowRepairSender_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                    afterActionPerformed(e);
        ...
        // contPrmtVin		
        this.contPrmtVin.setBoundLabelText(resHelper.getString("contPrmtVin.boundLabelText"));		
        this.contPrmtVin.setBoundLabelLength(80);		
        this.contPrmtVin.setBoundLabelUnderline(true);
        // contwipRemark		
        this.contwipRemark.setBoundLabelText(resHelper.getString("contwipRemark.boundLabelText"));		
        this.contwipRemark.setBoundLabelLength(80);		
        this.contwipRemark.setBoundLabelUnderline(true);		
        this.contwipRemark.setVisible(true);
        // contbizPerson		
        this.contbizPerson.setBoundLabelText(resHelper.getString("contbizPerson.boundLabelText"));		
        this.contbizPerson.setBoundLabelLength(80);		
        this.contbizPerson.setBoundLabelUnderline(true);		
        this.contbizPerson.setVisible(true);
        // contbizDept		
        this.contbizDept.setBoundLabelText(resHelper.getString("contbizDept.boundLabelText"));		
        this.contbizDept.setBoundLabelLength(80);		
        this.contbizDept.setBoundLabelUnderline(true);		
        this.contbizDept.setVisible(true);
        // contdmsWip		
        this.contdmsWip.setBoundLabelText(resHelper.getString("contdmsWip.boundLabelText"));		
        this.contdmsWip.setBoundLabelLength(80);		
        this.contdmsWip.setBoundLabelUnderline(true);		
        this.contdmsWip.setVisible(true);
        ...
        this.prmtCustomerAccount.setCommitFormat("$number$;$name$");		
        this.prmtCustomerAccount.setRequired(true);		
        this.prmtCustomerAccount.setLabelVisible(true);
        		EntityViewInfo eviprmtCustomerAccount = new EntityViewInfo ();
		eviprmtCustomerAccount.setFilter(com.kingdee.eas.framework.FrameWorkUtils.getF7FilterInfoByAuthorizedOrg(com.kingdee.eas.basedata.org.OrgType.getEnum("Admin"),"orgUnit.id"));
		prmtCustomerAccount.setEntityViewInfo(eviprmtCustomerAccount);
        ...
        // prmtrepairBizType		
        this.prmtrepairBizType.setQueryInfo("com.kingdee.eas.ga.rs.app.RepairWOBizTypeQuery");		
        this.prmtrepairBizType.setEditable(true);		
        this.prmtrepairBizType.setDisplayFormat("$name$");		
        this.prmtrepairBizType.setEditFormat("$number$");		
        this.prmtrepairBizType.setCommitFormat("$number$");		
        this.prmtrepairBizType.setRequired(false);
        // pkfirstBookInDate		
        this.pkfirstBookInDate.setRequired(false);
        // prmtVin
        // scrollPanewipRemark
        // txtwipRemark		
        this.txtwipRemark.setVisible(true);		
        this.txtwipRemark.setRequired(false);		
        this.txtwipRemark.setMaxLength(255);
        // prmtbizPerson		
        this.prmtbizPerson.setQueryInfo("com.kingdee.eas.basedata.person.app.PersonQuery");		
        this.prmtbizPerson.setVisible(true);		
        ...
        // prmtbizDept		
        this.prmtbizDept.setQueryInfo("com.kingdee.eas.basedata.org.app.AdminItemQuery");		
        this.prmtbizDept.setVisible(true);		
        this.prmtbizDept.setEditable(true);		
        this.prmtbizDept.setDisplayFormat("$name$");		
        this.prmtbizDept.setEditFormat("$number$");		
        this.prmtbizDept.setCommitFormat("$number$");		
        this.prmtbizDept.setRequired(false);		
        this.prmtbizDept.setEnabled(false);
        // txtdmsWip		
        this.txtdmsWip.setVisible(true);		
        this.txtdmsWip.setHorizontalAlignment(2);		
        this.txtdmsWip.setMaxLength(100);		
        this.txtdmsWip.setRequired(false);
        // kDLabelContainer9		
        ...
        this.contSaler.setBoundLabelLength(80);		
        ...
        final KDBizPromptBox kdtRWOItemSpEntry_repairPkg_PromptBox = new KDBizPromptBox();
        kdtRWOItemSpEntry_repairPkg_PromptBox.setQueryInfo("com.kingdee.eas.ga.rs.app.RepairPackageQuery");
        kdtRWOItemSpEntry_repairPkg_PromptBox.setVisible(true);
        kdtRWOItemSpEntry_repairPkg_PromptBox.setEditable(true);
        kdtRWOItemSpEntry_repairPkg_PromptBox.setDisplayFormat("$number$");
        kdtRWOItemSpEntry_repairPkg_PromptBox.setEditFormat("$number$");
        kdtRWOItemSpEntry_repairPkg_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtRWOItemSpEntry_repairPkg_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_repairPkg_PromptBox);
        this.kdtRWOItemSpEntry.getColumn("repairPkg").setEditor(kdtRWOItemSpEntry_repairPkg_CellEditor);
        ObjectValueRender kdtRWOItemSpEntry_repairPkg_OVR = new ObjectValueRender();
        kdtRWOItemSpEntry_repairPkg_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtRWOItemSpEntry.getColumn("repairPkg").setRenderer(kdtRWOItemSpEntry_repairPkg_OVR);
        ...
        KDFormattedTextField kdtRWOItemSpEntry_taxPrice_TextField = new KDFormattedTextField();
        kdtRWOItemSpEntry_taxPrice_TextField.setName("kdtRWOItemSpEntry_taxPrice_TextField");
        kdtRWOItemSpEntry_taxPrice_TextField.setVisible(true);
        kdtRWOItemSpEntry_taxPrice_TextField.setEditable(true);
        kdtRWOItemSpEntry_taxPrice_TextField.setHorizontalAlignment(2);
        kdtRWOItemSpEntry_taxPrice_TextField.setDataType(1);
        	kdtRWOItemSpEntry_taxPrice_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtRWOItemSpEntry_taxPrice_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtRWOItemSpEntry_taxPrice_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtRWOItemSpEntry_taxPrice_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_taxPrice_TextField);
        this.kdtRWOItemSpEntry.getColumn("taxPrice").setEditor(kdtRWOItemSpEntry_taxPrice_CellEditor);
        ...
        KDFormattedTextField kdtRWOItemSpEntry_taxAmount_TextField = new KDFormattedTextField();
        kdtRWOItemSpEntry_taxAmount_TextField.setName("kdtRWOItemSpEntry_taxAmount_TextField");
        kdtRWOItemSpEntry_taxAmount_TextField.setVisible(true);
        kdtRWOItemSpEntry_taxAmount_TextField.setEditable(true);
        kdtRWOItemSpEntry_taxAmount_TextField.setHorizontalAlignment(2);
        kdtRWOItemSpEntry_taxAmount_TextField.setDataType(1);
        	kdtRWOItemSpEntry_taxAmount_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtRWOItemSpEntry_taxAmount_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtRWOItemSpEntry_taxAmount_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtRWOItemSpEntry_taxAmount_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_taxAmount_TextField);
        this.kdtRWOItemSpEntry.getColumn("taxAmount").setEditor(kdtRWOItemSpEntry_taxAmount_CellEditor);
        ...
        KDFormattedTextField kdtRWOItemSpEntry_allocateExenseRate_TextField = new KDFormattedTextField();
        kdtRWOItemSpEntry_allocateExenseRate_TextField.setName("kdtRWOItemSpEntry_allocateExenseRate_TextField");
        kdtRWOItemSpEntry_allocateExenseRate_TextField.setVisible(true);
        kdtRWOItemSpEntry_allocateExenseRate_TextField.setEditable(true);
        kdtRWOItemSpEntry_allocateExenseRate_TextField.setHorizontalAlignment(2);
        kdtRWOItemSpEntry_allocateExenseRate_TextField.setDataType(1);
        	kdtRWOItemSpEntry_allocateExenseRate_TextField.setMinimumValue(new java.math.BigDecimal("-999.99"));
        	kdtRWOItemSpEntry_allocateExenseRate_TextField.setMaximumValue(new java.math.BigDecimal("999.99"));
        kdtRWOItemSpEntry_allocateExenseRate_TextField.setPrecision(2);
        KDTDefaultCellEditor kdtRWOItemSpEntry_allocateExenseRate_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_allocateExenseRate_TextField);
        this.kdtRWOItemSpEntry.getColumn("allocateExenseRate").setEditor(kdtRWOItemSpEntry_allocateExenseRate_CellEditor);
        final KDBizPromptBox kdtRWOItemSpEntry_person_PromptBox = new KDBizPromptBox();
        kdtRWOItemSpEntry_person_PromptBox.setQueryInfo("com.kingdee.eas.basedata.person.app.PersonQuery");
        kdtRWOItemSpEntry_person_PromptBox.setVisible(true);
        kdtRWOItemSpEntry_person_PromptBox.setEditable(true);
        kdtRWOItemSpEntry_person_PromptBox.setDisplayFormat("$number$");
        kdtRWOItemSpEntry_person_PromptBox.setEditFormat("$number$");
        kdtRWOItemSpEntry_person_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtRWOItemSpEntry_person_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_person_PromptBox);
        this.kdtRWOItemSpEntry.getColumn("person").setEditor(kdtRWOItemSpEntry_person_CellEditor);
        ObjectValueRender kdtRWOItemSpEntry_person_OVR = new ObjectValueRender();
        kdtRWOItemSpEntry_person_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtRWOItemSpEntry.getColumn("person").setRenderer(kdtRWOItemSpEntry_person_OVR);
        KDFormattedTextField kdtRWOItemSpEntry_worktimeQty_TextField = new KDFormattedTextField();
        kdtRWOItemSpEntry_worktimeQty_TextField.setName("kdtRWOItemSpEntry_worktimeQty_TextField");
        kdtRWOItemSpEntry_worktimeQty_TextField.setVisible(true);
        kdtRWOItemSpEntry_worktimeQty_TextField.setEditable(true);
        kdtRWOItemSpEntry_worktimeQty_TextField.setHorizontalAlignment(2);
        kdtRWOItemSpEntry_worktimeQty_TextField.setDataType(1);
        	kdtRWOItemSpEntry_worktimeQty_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtRWOItemSpEntry_worktimeQty_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtRWOItemSpEntry_worktimeQty_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtRWOItemSpEntry_worktimeQty_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_worktimeQty_TextField);
        this.kdtRWOItemSpEntry.getColumn("worktimeQty").setEditor(kdtRWOItemSpEntry_worktimeQty_CellEditor);
        KDFormattedTextField kdtRWOItemSpEntry_worktimePrice_TextField = new KDFormattedTextField();
        kdtRWOItemSpEntry_worktimePrice_TextField.setName("kdtRWOItemSpEntry_worktimePrice_TextField");
        kdtRWOItemSpEntry_worktimePrice_TextField.setVisible(true);
        kdtRWOItemSpEntry_worktimePrice_TextField.setEditable(true);
        kdtRWOItemSpEntry_worktimePrice_TextField.setHorizontalAlignment(2);
        kdtRWOItemSpEntry_worktimePrice_TextField.setDataType(1);
        	kdtRWOItemSpEntry_worktimePrice_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtRWOItemSpEntry_worktimePrice_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtRWOItemSpEntry_worktimePrice_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtRWOItemSpEntry_worktimePrice_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_worktimePrice_TextField);
        this.kdtRWOItemSpEntry.getColumn("worktimePrice").setEditor(kdtRWOItemSpEntry_worktimePrice_CellEditor);
        KDFormattedTextField kdtRWOItemSpEntry_worktimeCost_TextField = new KDFormattedTextField();
        kdtRWOItemSpEntry_worktimeCost_TextField.setName("kdtRWOItemSpEntry_worktimeCost_TextField");
        kdtRWOItemSpEntry_worktimeCost_TextField.setVisible(true);
        kdtRWOItemSpEntry_worktimeCost_TextField.setEditable(true);
        kdtRWOItemSpEntry_worktimeCost_TextField.setHorizontalAlignment(2);
        kdtRWOItemSpEntry_worktimeCost_TextField.setDataType(1);
        	kdtRWOItemSpEntry_worktimeCost_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtRWOItemSpEntry_worktimeCost_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtRWOItemSpEntry_worktimeCost_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtRWOItemSpEntry_worktimeCost_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_worktimeCost_TextField);
        this.kdtRWOItemSpEntry.getColumn("worktimeCost").setEditor(kdtRWOItemSpEntry_worktimeCost_CellEditor);
        final KDBizPromptBox kdtRWOItemSpEntry_giftDept_PromptBox = new KDBizPromptBox();
        kdtRWOItemSpEntry_giftDept_PromptBox.setQueryInfo("com.kingdee.eas.basedata.org.app.AdminItemQuery");
        kdtRWOItemSpEntry_giftDept_PromptBox.setVisible(true);
        kdtRWOItemSpEntry_giftDept_PromptBox.setEditable(true);
        kdtRWOItemSpEntry_giftDept_PromptBox.setDisplayFormat("$number$");
        kdtRWOItemSpEntry_giftDept_PromptBox.setEditFormat("$number$");
        kdtRWOItemSpEntry_giftDept_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtRWOItemSpEntry_giftDept_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_giftDept_PromptBox);
        this.kdtRWOItemSpEntry.getColumn("giftDept").setEditor(kdtRWOItemSpEntry_giftDept_CellEditor);
        ObjectValueRender kdtRWOItemSpEntry_giftDept_OVR = new ObjectValueRender();
        kdtRWOItemSpEntry_giftDept_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtRWOItemSpEntry.getColumn("giftDept").setRenderer(kdtRWOItemSpEntry_giftDept_OVR);
        ...
        kdtRWOItemSpEntry_repairWay_ComboBox.addItems(EnumUtils.getEnumList("com.kingdee.eas.auto4s.rsm.rs.RepairWayEnum").toArray());
        ...
        this.kdtRWOItemSpEntry.getColumn("repairWay").setEditor(kdtRWOItemSpEntry_repairWay_CellEditor);
        final KDBizPromptBox kdtRWOItemSpEntry_supplier_PromptBox = new KDBizPromptBox();
        kdtRWOItemSpEntry_supplier_PromptBox.setQueryInfo("com.kingdee.eas.basedata.master.cssp.app.F7SupplierDefaultQuery");
        kdtRWOItemSpEntry_supplier_PromptBox.setVisible(true);
        kdtRWOItemSpEntry_supplier_PromptBox.setEditable(true);
        kdtRWOItemSpEntry_supplier_PromptBox.setDisplayFormat("$number$");
        kdtRWOItemSpEntry_supplier_PromptBox.setEditFormat("$number$");
        kdtRWOItemSpEntry_supplier_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtRWOItemSpEntry_supplier_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_supplier_PromptBox);
        this.kdtRWOItemSpEntry.getColumn("supplier").setEditor(kdtRWOItemSpEntry_supplier_CellEditor);
        ...
        KDCheckBox kdtRWOItemSpEntry_isCreateTo2_CheckBox = new KDCheckBox();
        kdtRWOItemSpEntry_isCreateTo2_CheckBox.setName("kdtRWOItemSpEntry_isCreateTo2_CheckBox");
        KDTDefaultCellEditor kdtRWOItemSpEntry_isCreateTo2_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_isCreateTo2_CheckBox);
        this.kdtRWOItemSpEntry.getColumn("isCreateTo2").setEditor(kdtRWOItemSpEntry_isCreateTo2_CellEditor);
        KDFormattedTextField kdtRWOItemSpEntry_initFactPrice_TextField = new KDFormattedTextField();
        kdtRWOItemSpEntry_initFactPrice_TextField.setName("kdtRWOItemSpEntry_initFactPrice_TextField");
        kdtRWOItemSpEntry_initFactPrice_TextField.setVisible(true);
        kdtRWOItemSpEntry_initFactPrice_TextField.setEditable(true);
        kdtRWOItemSpEntry_initFactPrice_TextField.setHorizontalAlignment(2);
        kdtRWOItemSpEntry_initFactPrice_TextField.setDataType(1);
        	kdtRWOItemSpEntry_initFactPrice_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtRWOItemSpEntry_initFactPrice_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtRWOItemSpEntry_initFactPrice_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtRWOItemSpEntry_initFactPrice_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_initFactPrice_TextField);
        this.kdtRWOItemSpEntry.getColumn("initFactPrice").setEditor(kdtRWOItemSpEntry_initFactPrice_CellEditor);
        KDFormattedTextField kdtRWOItemSpEntry_wprice_TextField = new KDFormattedTextField();
        kdtRWOItemSpEntry_wprice_TextField.setName("kdtRWOItemSpEntry_wprice_TextField");
        kdtRWOItemSpEntry_wprice_TextField.setVisible(true);
        kdtRWOItemSpEntry_wprice_TextField.setEditable(true);
        kdtRWOItemSpEntry_wprice_TextField.setHorizontalAlignment(2);
        kdtRWOItemSpEntry_wprice_TextField.setDataType(1);
        	kdtRWOItemSpEntry_wprice_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtRWOItemSpEntry_wprice_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtRWOItemSpEntry_wprice_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtRWOItemSpEntry_wprice_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_wprice_TextField);
        this.kdtRWOItemSpEntry.getColumn("wprice").setEditor(kdtRWOItemSpEntry_wprice_CellEditor);
        KDFormattedTextField kdtRWOItemSpEntry_originalQty_TextField = new KDFormattedTextField();
        kdtRWOItemSpEntry_originalQty_TextField.setName("kdtRWOItemSpEntry_originalQty_TextField");
        kdtRWOItemSpEntry_originalQty_TextField.setVisible(true);
        kdtRWOItemSpEntry_originalQty_TextField.setEditable(true);
        kdtRWOItemSpEntry_originalQty_TextField.setHorizontalAlignment(2);
        kdtRWOItemSpEntry_originalQty_TextField.setDataType(1);
        	kdtRWOItemSpEntry_originalQty_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtRWOItemSpEntry_originalQty_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        ...
        KDTextField kdtRWOItemSpEntry_arNumber_TextField = new KDTextField();
        kdtRWOItemSpEntry_arNumber_TextField.setName("kdtRWOItemSpEntry_arNumber_TextField");
        kdtRWOItemSpEntry_arNumber_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtRWOItemSpEntry_arNumber_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_arNumber_TextField);
        this.kdtRWOItemSpEntry.getColumn("arNumber").setEditor(kdtRWOItemSpEntry_arNumber_CellEditor);
        KDTextField kdtRWOItemSpEntry_receiveNumber_TextField = new KDTextField();
        kdtRWOItemSpEntry_receiveNumber_TextField.setName("kdtRWOItemSpEntry_receiveNumber_TextField");
        kdtRWOItemSpEntry_receiveNumber_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtRWOItemSpEntry_receiveNumber_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_receiveNumber_TextField);
        this.kdtRWOItemSpEntry.getColumn("receiveNumber").setEditor(kdtRWOItemSpEntry_receiveNumber_CellEditor);
        KDCheckBox kdtRWOItemSpEntry_isCreatedTo_CheckBox = new KDCheckBox();
        kdtRWOItemSpEntry_isCreatedTo_CheckBox.setName("kdtRWOItemSpEntry_isCreatedTo_CheckBox");
        KDTDefaultCellEditor kdtRWOItemSpEntry_isCreatedTo_CellEditor = new KDTDefaultCellEditor(kdtRWOItemSpEntry_isCreatedTo_CheckBox);
        this.kdtRWOItemSpEntry.getColumn("isCreatedTo").setEditor(kdtRWOItemSpEntry_isCreatedTo_CellEditor);
        // kDLabelContainer8		
    ...
    public void initUIContentLayout()
    {
        ...
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(0, 0, 974, 219));        contCompanyNumber.setBounds(new Rectangle(246, 10, 217, 19));
        kDPanel1.add(contCompanyNumber, new KDLayout.Constraints(246, 10, 217, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contNumber.setBounds(new Rectangle(10, 10, 208, 19));
        kDPanel1.add(contNumber, new KDLayout.Constraints(10, 10, 208, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDTabbedPane1.setBounds(new Rectangle(2, 41, 968, 174));
        kDPanel1.add(kDTabbedPane1, new KDLayout.Constraints(2, 41, 968, 174, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contgaBillStatus.setBounds(new Rectangle(489, 10, 217, 19));
        kDPanel1.add(contgaBillStatus, new KDLayout.Constraints(489, 10, 217, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        chkisPrintedSettle.setBounds(new Rectangle(728, 10, 217, 18));
        kDPanel1.add(chkisPrintedSettle, new KDLayout.Constraints(728, 10, 217, 18, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCompanyNumber
        ...
        kDPBizInfo.putClientProperty("OriginalBounds", new Rectangle(0, 0, 967, 141));        contModel.setBounds(new Rectangle(484, 4, 217, 19));
        ...
        contMile.setBounds(new Rectangle(484, 60, 217, 19));
        kDPBizInfo.add(contMile, new KDLayout.Constraints(484, 60, 217, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contIntendDeliveryTime.setBounds(new Rectangle(240, 60, 217, 19));
        kDPBizInfo.add(contIntendDeliveryTime, new KDLayout.Constraints(240, 60, 217, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contComeTime.setBounds(new Rectangle(5, 60, 208, 19));
        kDPBizInfo.add(contComeTime, new KDLayout.Constraints(5, 60, 208, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contSA.setBounds(new Rectangle(5, 32, 208, 19));
        ...
        contwipRemark.setBounds(new Rectangle(4, 115, 452, 23));
        kDPBizInfo.add(contwipRemark, new KDLayout.Constraints(4, 115, 452, 23, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbizPerson.setBounds(new Rectangle(240, 89, 217, 19));
        kDPBizInfo.add(contbizPerson, new KDLayout.Constraints(240, 89, 217, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbizDept.setBounds(new Rectangle(484, 89, 217, 19));
        kDPBizInfo.add(contbizDept, new KDLayout.Constraints(484, 89, 217, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contdmsWip.setBounds(new Rectangle(484, 115, 217, 19));
        kDPBizInfo.add(contdmsWip, new KDLayout.Constraints(484, 115, 217, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contModel
        ...
        //contrepairBizType
        contrepairBizType.setBoundEditor(prmtrepairBizType);
        //contfirstBookInDate
        contfirstBookInDate.setBoundEditor(pkfirstBookInDate);
        //contPrmtVin
        contPrmtVin.setBoundEditor(prmtVin);
        //contwipRemark
        contwipRemark.setBoundEditor(scrollPanewipRemark);
        //scrollPanewipRemark
        scrollPanewipRemark.getViewport().add(txtwipRemark, null);
        //contbizPerson
        contbizPerson.setBoundEditor(prmtbizPerson);
        //contbizDept
        contbizDept.setBoundEditor(prmtbizDept);
        //contdmsWip
        contdmsWip.setBoundEditor(txtdmsWip);
        //kDPVehicleInfo
        kDPVehicleInfo.setLayout(new KDLayout());
        kDPVehicleInfo.putClientProperty("OriginalBounds", new Rectangle(0, 0, 967, 141));        kDLabelContainer1.setBounds(new Rectangle(10, 5, 270, 19));
        ...
        kDPVehicleInfo.add(contRemark, new KDLayout.Constraints(322, 57, 270, 58, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //kDLabelContainer1
        ...
        kDPHideField.putClientProperty("OriginalBounds", new Rectangle(0, 0, 967, 141));        kDLabelContainer2.setBounds(new Rectangle(5, 25, 270, 19));
        ...
        contVIN.setBounds(new Rectangle(554, 56, 217, 19));
        kDPHideField.add(contVIN, new KDLayout.Constraints(554, 56, 217, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contCustomerRequest.setBounds(new Rectangle(347, 14, 271, 22));
        kDPHideField.add(contCustomerRequest, new KDLayout.Constraints(347, 14, 271, 22, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contStatus.setBounds(new Rectangle(575, 11, 270, 19));
        kDPHideField.add(contStatus, new KDLayout.Constraints(575, 11, 270, 19, 0));
        ...
        contsaleType.setBounds(new Rectangle(686, 129, 270, 19));
        ...
        contSaler.setBounds(new Rectangle(251, 42, 217, 19));
        kDPHideField.add(contSaler, new KDLayout.Constraints(251, 42, 217, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //kDLabelContainer2
        ...
        //contgaBillStatus
        contgaBillStatus.setBoundEditor(gaBillStatus);
        //kDTRWOPane
        ...
        kDPRwoItem.putClientProperty("OriginalBounds", new Rectangle(0, 0, 973, 500));        kdtRWORepairItemEntry.setBounds(new Rectangle(0, 0, 973, 470));
...
vo.put("ItemStatus","1");
        ...
        kDPRwoSp.putClientProperty("OriginalBounds", new Rectangle(0, 0, 973, 500));        kdtRWOSparepartEntry.setBounds(new Rectangle(0, 0, 973, 478));
...
vo.put("SettleObject","1");
        ...
        kDPSpk.putClientProperty("OriginalBounds", new Rectangle(0, 0, 973, 500));        kdtRWORepairPkgEntry.setBounds(new Rectangle(0, 0, 973, 479));
        ...
        kDPAct.putClientProperty("OriginalBounds", new Rectangle(0, 0, 973, 500));        kdtRWOActivityEntry.setBounds(new Rectangle(0, 0, 973, 475));
        ...
        kDPAcc.putClientProperty("OriginalBounds", new Rectangle(0, 0, 973, 500));        kdtRWOAttachmentItemEntry.setBounds(new Rectangle(0, 0, 973, 475));
        ...
        KDPAmount.putClientProperty("OriginalBounds", new Rectangle(0, 0, 973, 500));        kdtRWOTotalAmountEntry.setBounds(new Rectangle(0, 0, 973, 478));
...
vo.put("AmountClassify","1");
        ...
        kDPBreak.putClientProperty("OriginalBounds", new Rectangle(0, 0, 973, 500));        kdtRepairBreakEntry.setBounds(new Rectangle(0, 0, 971, 477));
        ...
        kDPRwoItemSp.putClientProperty("OriginalBounds", new Rectangle(0, 0, 973, 500));        kdtRWOItemSpEntry.setBounds(new Rectangle(4, 34, 962, 442));
...
vo.put("repairWay","0");
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("isPrintedSettle", boolean.class, this.chkisPrintedSettle, "selected");
		...
		dataBinder.registerBinding("wipRemark", String.class, this.txtwipRemark, "text");
		dataBinder.registerBinding("bizPerson", com.kingdee.eas.basedata.person.PersonInfo.class, this.prmtbizPerson, "data");
		dataBinder.registerBinding("bizDept", com.kingdee.eas.basedata.org.AdminOrgUnitInfo.class, this.prmtbizDept, "data");
		dataBinder.registerBinding("dmsWip", String.class, this.txtdmsWip, "text");
		...
		dataBinder.registerBinding("gaBillStatus", com.kingdee.eas.ga.rs.RepairWOStatusEnum.class, this.gaBillStatus, "selectedItem");
		...
		dataBinder.registerBinding("RWOItemSpEntry.taxPrice", java.math.BigDecimal.class, this.kdtRWOItemSpEntry, "taxPrice.text");
		dataBinder.registerBinding("RWOItemSpEntry.taxAmount", java.math.BigDecimal.class, this.kdtRWOItemSpEntry, "taxAmount.text");
		dataBinder.registerBinding("RWOItemSpEntry.repairPkg", java.lang.Object.class, this.kdtRWOItemSpEntry, "repairPkg.text");
		dataBinder.registerBinding("RWOItemSpEntry.allocateExenseRate", java.math.BigDecimal.class, this.kdtRWOItemSpEntry, "allocateExenseRate.text");
		dataBinder.registerBinding("RWOItemSpEntry.repairWay", com.kingdee.util.enums.Enum.class, this.kdtRWOItemSpEntry, "repairWay.text");
		dataBinder.registerBinding("RWOItemSpEntry.supplier", java.lang.Object.class, this.kdtRWOItemSpEntry, "supplier.text");
		dataBinder.registerBinding("RWOItemSpEntry.initFactPrice", java.math.BigDecimal.class, this.kdtRWOItemSpEntry, "initFactPrice.text");
		dataBinder.registerBinding("RWOItemSpEntry.wprice", java.math.BigDecimal.class, this.kdtRWOItemSpEntry, "wprice.text");
		dataBinder.registerBinding("RWOItemSpEntry.originalEntryId", String.class, this.kdtRWOItemSpEntry, "originalEntryId.text");
		...
		dataBinder.registerBinding("RWOItemSpEntry.relateItemEntryId", String.class, this.kdtRWOItemSpEntry, "relateItemEntryId.text");
		dataBinder.registerBinding("RWOItemSpEntry.giftDept", java.lang.Object.class, this.kdtRWOItemSpEntry, "giftDept.text");
		dataBinder.registerBinding("RWOItemSpEntry.worktimeQty", java.math.BigDecimal.class, this.kdtRWOItemSpEntry, "worktimeQty.text");
		dataBinder.registerBinding("RWOItemSpEntry.worktimePrice", java.math.BigDecimal.class, this.kdtRWOItemSpEntry, "worktimePrice.text");
		dataBinder.registerBinding("RWOItemSpEntry.worktimeCost", java.math.BigDecimal.class, this.kdtRWOItemSpEntry, "worktimeCost.text");
		dataBinder.registerBinding("RWOItemSpEntry.arNumber", String.class, this.kdtRWOItemSpEntry, "arNumber.text");
		dataBinder.registerBinding("RWOItemSpEntry.receiveNumber", String.class, this.kdtRWOItemSpEntry, "receiveNumber.text");
		dataBinder.registerBinding("RWOItemSpEntry.isCreatedTo", boolean.class, this.kdtRWOItemSpEntry, "isCreatedTo.text");		
	}
	//Regiester UI State
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("isPrintedSettle", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("wipRemark", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("dmsWip", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("gaBillStatus", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("RWOItemSpEntry.taxPrice", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.taxAmount", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.repairPkg", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.allocateExenseRate", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.repairWay", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.supplier", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.initFactPrice", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.wprice", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.originalEntryId", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("RWOItemSpEntry.relateItemEntryId", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.giftDept", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.worktimeQty", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.worktimePrice", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.worktimeCost", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.arNumber", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.receiveNumber", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("RWOItemSpEntry.isCreatedTo", ValidateHelper.ON_SAVE);    		
	}
    ...
    /**
     * output btnShowRepairSender_actionPerformed method
     */
    protected void btnShowRepairSender_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
...
kdtRWOAttachmentItemEntry.getCell(rowIndex,"AttaItemName").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtRWOAttachmentItemEntry.getCell(rowIndex,"AttaItem").getValue(),"name"));
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("repairBizType.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("repairBizType.id"));
        	sic.add(new SelectorItemInfo("repairBizType.number"));
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
        	...
        	sic.add(new SelectorItemInfo("bizDept.id"));
        	sic.add(new SelectorItemInfo("bizDept.number"));
        	sic.add(new SelectorItemInfo("bizDept.name"));
		}
    	...
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.taxPrice"));
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.taxAmount"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("RWOItemSpEntry.repairPkg.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("RWOItemSpEntry.repairPkg.id"));
			sic.add(new SelectorItemInfo("RWOItemSpEntry.repairPkg.name"));
        	sic.add(new SelectorItemInfo("RWOItemSpEntry.repairPkg.number"));
		}
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.allocateExenseRate"));
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.repairWay"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("RWOItemSpEntry.supplier.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("RWOItemSpEntry.supplier.id"));
			sic.add(new SelectorItemInfo("RWOItemSpEntry.supplier.name"));
        	sic.add(new SelectorItemInfo("RWOItemSpEntry.supplier.number"));
		}
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.initFactPrice"));
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.wprice"));
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.originalEntryId"));
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.originalQty"));
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.isCreateTo2"));
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.settleDate"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("RWOItemSpEntry.person.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("RWOItemSpEntry.person.id"));
    	...
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.relateItemEntryId"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("RWOItemSpEntry.giftDept.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("RWOItemSpEntry.giftDept.id"));
			sic.add(new SelectorItemInfo("RWOItemSpEntry.giftDept.name"));
        	sic.add(new SelectorItemInfo("RWOItemSpEntry.giftDept.number"));
		}
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.worktimeQty"));
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.worktimePrice"));
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.worktimeCost"));
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.arNumber"));
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.receiveNumber"));
    	sic.add(new SelectorItemInfo("RWOItemSpEntry.isCreatedTo"));
        return sic;
    }        
    ...
    /**
     * output actionShowRemarkList_actionPerformed method
     */
    public void actionShowRemarkList_actionPerformed(ActionEvent e) throws Exception
    {
    }
	...
	public RequestContext prepareActionShowRemarkList(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionShowRemarkList() {
    	return false;
    }
	public RequestContext prepareActionSplitLine(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractRepairWOEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractRepairWOEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }

    /**
     * output ActionShowRemarkList class
     */     
    protected class ActionShowRemarkList extends ItemAction {     
    
        public ActionShowRemarkList()
        {
            this(null);
        }

        public ActionShowRemarkList(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            this.setEnabled(false);
            _tempStr = resHelper.getString("ActionShowRemarkList.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionShowRemarkList.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionShowRemarkList.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractRepairWOEditUI.this, "ActionShowRemarkList", "actionShowRemarkList_actionPerformed", e);
        }
    }

    /**
     * output ActionSplitLine class
     */     
    protected class ActionSplitLine extends ItemAction {     
    
        public ActionSplitLine()
        {
            this(null);
        }

        public ActionSplitLine(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            _tempStr = resHelper.getString("ActionSplitLine.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionSplitLine.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionSplitLine.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
