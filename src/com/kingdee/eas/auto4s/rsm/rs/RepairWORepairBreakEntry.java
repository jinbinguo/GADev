...
public class RepairWORepairBreakEntry extends CoreBillEntryBase implements IRepairWORepairBreakEntry
{
    public RepairWORepairBreakEntry()
    {
        super();
        registerInterface(IRepairWORepairBreakEntry.class, this);
    }
    public RepairWORepairBreakEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IRepairWORepairBreakEntry.class, this);
    }
    ...
    private RepairWORepairBreakEntryController getController() throws BOSException
    {
        return (RepairWORepairBreakEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRepairWORepairBreakEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRepairWORepairBreakEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRepairWORepairBreakEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRepairWORepairBreakEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRepairWORepairBreakEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRepairWORepairBreakEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
