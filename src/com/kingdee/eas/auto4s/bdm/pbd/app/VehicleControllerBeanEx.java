...
public class VehicleControllerBeanEx extends com.kingdee.eas.auto4s.bdm.pbd.app.VehicleControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.auto4s.bdm.pbd.app.VehicleControllerBeanEx");
    
    @Override
    protected List isVehicleExistByNumber(Context ctx, IObjectValue model,
