 ...
 * output class name
 */
public class RepairItemListUIPIEx extends RepairItemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RepairItemListUIPIEx.class);
    
    /**
     * output class constructor
     */
    public RepairItemListUIPIEx() throws Exception
    {
        super();
    }
