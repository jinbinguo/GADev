 ...
 * output class name
 */
public class RepairItemListUI extends AbstractRepairItemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RepairItemListUI.class);
    
    /**
     * output class constructor
     */
    public RepairItemListUI() throws Exception
    {
        super();
    }
    ...
    /**
     * output actionExportExcelTemplate_actionPerformed
     */
    public void actionExportExcelTemplate_actionPerformed(ActionEvent e) throws Exception
    {
        super.actionExportExcelTemplate_actionPerformed(e);
    }
    ...
    {
        return com.kingdee.eas.auto4s.bdm.rsm.RepairItemTreeFactory.getRemoteInstance();
    }
    ...
    {
        return com.kingdee.eas.auto4s.bdm.rsm.client.RepairItemTreeEditUI.class.getName();
    }
