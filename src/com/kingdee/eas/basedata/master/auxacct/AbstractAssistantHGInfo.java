...
public class AbstractAssistantHGInfo extends com.kingdee.eas.framework.ObjectBaseInfo implements Serializable 
{
    ...
    /**
     * Object: 辅助账横表 's 返利项目 property 
     */
    public com.kingdee.eas.auto4s.bdm.vm.ReturnItemInfo getReturnItem()
    {
        return (com.kingdee.eas.auto4s.bdm.vm.ReturnItemInfo)get("ReturnItem");
    }
    public void setReturnItem(com.kingdee.eas.auto4s.bdm.vm.ReturnItemInfo item)
    {
        put("ReturnItem", item);
    }
    /**
     * Object: 辅助账横表 's 品牌 property 
     */
    ...
    /**
     * Object: 辅助账横表 's 车型来源 property 
     */
    public com.kingdee.eas.auto4s.bdm.pbd.ModelSourceInfo getModelSource()
    {
        return (com.kingdee.eas.auto4s.bdm.pbd.ModelSourceInfo)get("ModelSource");
    }
    public void setModelSource(com.kingdee.eas.auto4s.bdm.pbd.ModelSourceInfo item)
    {
        put("ModelSource", item);
    }
    /**
     * Object: 辅助账横表 's 付费类别 property 
     */
    ...
    /**
     * Object: 辅助账横表 's 维修班组 property 
     */
    public com.kingdee.eas.auto4s.bdm.rsm.RepairGroupInfo getRepairGroup()
    {
        return (com.kingdee.eas.auto4s.bdm.rsm.RepairGroupInfo)get("RepairGroup");
    }
    public void setRepairGroup(com.kingdee.eas.auto4s.bdm.rsm.RepairGroupInfo item)
    {
        put("RepairGroup", item);
    }
