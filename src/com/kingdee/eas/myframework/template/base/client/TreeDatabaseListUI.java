...
public class TreeDatabaseListUI extends AbstractTreeDatabaseListUI {
	private static final Logger logger = CoreUIObject
			.getLogger(TreeDatabaseListUI.class);

	public TreeDatabaseListUI() throws Exception {
		super();
	}
	...
	public void actionCancelCancel_actionPerformed(ActionEvent e)
		...
		if (isCanCancelCancel) {
			...
			getBizInterface().update(corebaseCol);
			execQuery(); //treelist底层refresh()写法问题,直接调用
		}
	}
