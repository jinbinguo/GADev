 ...
 * output class name
 */
public abstract class AbstractSimpleBizBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSimpleBizBillEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox boxBaseStatus;
    protected com.kingdee.bos.ctrl.swing.KDDatePicker kDDateAuditTime;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnUnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnMultiColumnSort;
    ...
    protected com.kingdee.eas.myframework.template.base.SimpleBizBillInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    protected ActionMultiColumnSort actionMultiColumnSort = null;
    /**
     * output class constructor
     */
    public AbstractSimpleBizBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSimpleBizBillEditUI.class.getName());
        ...
        //actionMultiColumnSort
        this.actionMultiColumnSort = new ActionMultiColumnSort(this);
        getActionManager().registerAction("actionMultiColumnSort", actionMultiColumnSort);
         this.actionMultiColumnSort.addService(new com.kingdee.eas.framework.client.service.PermissionService());
        ...
        this.boxBaseStatus = new com.kingdee.bos.ctrl.swing.KDComboBox();
        this.kDDateAuditTime = new com.kingdee.bos.ctrl.swing.KDDatePicker();
        this.btnAudit = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.btnUnAudit = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.btnMultiColumnSort = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        ...
        this.boxBaseStatus.setName("boxBaseStatus");
        this.kDDateAuditTime.setName("kDDateAuditTime");
        this.btnAudit.setName("btnAudit");
        this.btnUnAudit.setName("btnUnAudit");
        this.btnMultiColumnSort.setName("btnMultiColumnSort");
        ...
        // boxBaseStatus		
        this.boxBaseStatus.setReadOnly(true);		
        this.boxBaseStatus.addItems(EnumUtils.getEnumList("com.kingdee.eas.scm.common.BillBaseStatusEnum").toArray());		
        this.boxBaseStatus.setEnabled(false);
        // kDDateAuditTime		
        this.kDDateAuditTime.setEnabled(false);		
        this.kDDateAuditTime.setTimeEnabled(true);
        // btnAudit
        ...
        // btnMultiColumnSort
        this.btnMultiColumnSort.setAction((IItemAction)ActionProxyFactory.getProxy(actionMultiColumnSort, new Class[] { IItemAction.class }, getServiceContext()));		
        this.btnMultiColumnSort.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTbtn_sortorder"));		
        this.btnMultiColumnSort.setToolTipText(resHelper.getString("btnMultiColumnSort.toolTipText"));
        // menuItemAudit
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(kdtEntrys, new KDLayout.Constraints(18, 78, 991, 473, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.myframework.template.base.app.SimpleBizBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.myframework.template.base.SimpleBizBillInfo)ov;
    }
    ...
    /**
     * output actionMultiColumnSort_actionPerformed method
     */
	...
	public RequestContext prepareActionMultiColumnSort(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionMultiColumnSort() {
    	return false;
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSimpleBizBillEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSimpleBizBillEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }

    /**
     * output ActionMultiColumnSort class
     */     
    protected class ActionMultiColumnSort extends ItemAction {     
    
        public ActionMultiColumnSort()
        {
            this(null);
        }

        public ActionMultiColumnSort(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            _tempStr = resHelper.getString("ActionMultiColumnSort.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionMultiColumnSort.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionMultiColumnSort.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSimpleBizBillEditUI.this, "ActionMultiColumnSort", "actionMultiColumnSort_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.myframework.template.base.client", "SimpleBizBillEditUI");
    }
    /**
