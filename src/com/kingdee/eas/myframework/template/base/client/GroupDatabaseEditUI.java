 ...
 * output class name
 */
public class GroupDatabaseEditUI extends AbstractGroupDatabaseEditUI {
	private static final Logger logger = CoreUIObject.getLogger(GroupDatabaseEditUI.class);
	private boolean isVerifyInput = false;
	
	public GroupDatabaseEditUI() throws Exception {
		super();
	}
