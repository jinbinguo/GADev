...
public class GroupDatabaseControllerBean extends AbstractGroupDatabaseControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.myframework.template.base.app.GroupDatabaseControllerBean");
