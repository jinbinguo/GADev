...
public class TreeDatabaseControllerBean extends AbstractTreeDatabaseControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.myframework.template.base.app.TreeDatabaseControllerBean");
    @Override
