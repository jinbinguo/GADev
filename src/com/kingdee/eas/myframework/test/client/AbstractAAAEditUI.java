 ...
 * output class name
 */
public abstract class AbstractAAAEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAAAEditUI.class);
     ...
     */
    public AbstractAAAEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAAAEditUI.class.getName());
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.myframework.test.AAAEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.myframework.test.app.AAAEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.myframework.test.AAAInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.myframework.test.client", "AAAEditUI");
    }
    /**
