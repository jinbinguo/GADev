 ...
 * output class name
 */
public class AAAListUI extends AbstractAAAListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AAAListUI.class);
    
    /**
     * output class constructor
     */
    public AAAListUI() throws Exception
    {
        super();
    }
