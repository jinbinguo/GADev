 ...
 * output class name
 */
public class TestGroupListUI extends AbstractTestGroupListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TestGroupListUI.class);
    
    /**
     * output class constructor
     */
    public TestGroupListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.myframework.test.client.TestGroupTreeEditUI.class.getName();
    }
