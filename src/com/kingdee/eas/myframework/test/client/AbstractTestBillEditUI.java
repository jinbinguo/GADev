 ...
 * output class name
 */
public abstract class AbstractTestBillEditUI extends com.kingdee.eas.myframework.template.base.client.SimpleBizBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTestBillEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtBIMUDF0001;
    protected com.kingdee.bos.ctrl.swing.KDScrollPane scrollPaneBIMUDF0005;
    protected com.kingdee.bos.ctrl.swing.KDTextArea txtBIMUDF0005;
    protected com.kingdee.eas.myframework.test.TestBillInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractTestBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTestBillEditUI.class.getName());
        ...
        KDTextField kdtEntrys_BIMUDF0001_TextField = new KDTextField();
        kdtEntrys_BIMUDF0001_TextField.setName("kdtEntrys_BIMUDF0001_TextField");
        kdtEntrys_BIMUDF0001_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntrys_BIMUDF0001_CellEditor = new KDTDefaultCellEditor(kdtEntrys_BIMUDF0001_TextField);
        ...
        // txtBIMUDF0005		
        this.txtBIMUDF0005.setVisible(true);		
        this.txtBIMUDF0005.setRequired(false);		
        this.txtBIMUDF0005.setMaxLength(255);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,boxBaseStatus,kDDateAuditTime,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,txtBIMUDF0001,kdtEntrys}));
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys.setBounds(new Rectangle(16, 119, 991, 442));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.myframework.test.TestBillEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(16, 119, 991, 442, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contBIMUDF0001.setBounds(new Rectangle(714, 41, 270, 19));
        this.add(contBIMUDF0001, new KDLayout.Constraints(714, 41, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contBIMUDF0005.setBounds(new Rectangle(20, 74, 681, 37));
        this.add(contBIMUDF0005, new KDLayout.Constraints(20, 74, 681, 37, 0));
        //contCreator
        ...
        //contBIMUDF0001
        contBIMUDF0001.setBoundEditor(txtBIMUDF0001);
        //contBIMUDF0005
        contBIMUDF0005.setBoundEditor(scrollPaneBIMUDF0005);
        //scrollPaneBIMUDF0005
        scrollPaneBIMUDF0005.getViewport().add(txtBIMUDF0005, null);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.myframework.test.TestBillEntryInfo.class, this.kdtEntrys, "userObject");
		dataBinder.registerBinding("entrys.BIMUDF0001", String.class, this.kdtEntrys, "BIMUDF0001.text");
		...
		dataBinder.registerBinding("BIMUDF0001", String.class, this.txtBIMUDF0001, "text");
		dataBinder.registerBinding("BIMUDF0005", String.class, this.txtBIMUDF0005, "text");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.myframework.test.app.TestBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.myframework.test.TestBillInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.BIMUDF0001", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.BIMUDF0001"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    {
        return new MetaDataPK("com.kingdee.eas.myframework.test.client", "TestBillEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.myframework.test.client.TestBillEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/myframework/test/TestBill";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.myframework.test.app.TestBillQuery");
	}
