...
public class TestBillEntryControllerBean extends AbstractTestBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.myframework.test.app.TestBillEntryControllerBean");
}