...
public class TestGroupControllerBean extends AbstractTestGroupControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.myframework.test.app.TestGroupControllerBean");
}