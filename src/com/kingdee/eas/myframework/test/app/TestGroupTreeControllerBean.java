...
public class TestGroupTreeControllerBean extends AbstractTestGroupTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.myframework.test.app.TestGroupTreeControllerBean");
}