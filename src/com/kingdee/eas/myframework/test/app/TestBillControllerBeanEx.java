...
public class TestBillControllerBeanEx extends com.kingdee.eas.myframework.test.app.TestBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.myframework.test.app.TestBillControllerBeanEx");
}				
