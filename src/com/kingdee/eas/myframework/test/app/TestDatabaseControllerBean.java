...
public class TestDatabaseControllerBean extends AbstractTestDatabaseControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.myframework.test.app.TestDatabaseControllerBean");
}