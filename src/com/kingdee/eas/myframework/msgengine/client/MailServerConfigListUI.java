 ...
 * output class name
 */
public class MailServerConfigListUI extends AbstractMailServerConfigListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MailServerConfigListUI.class);
    
    /**
     * output class constructor
     */
    public MailServerConfigListUI() throws Exception
    {
        super();
    }
