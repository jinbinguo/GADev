...
public class MailServerConfigControllerBean extends AbstractMailServerConfigControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.myframework.msgengine.app.MailServerConfigControllerBean");
